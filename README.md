...
| | |
|:---:|---|
| 🔍 | **Seeking Summer 2026 internships** in SWE, AI/ML, and agentic systems |
| 🧪 | Exploring **multi-agent orchestration** and **multimodal AI pipelines** |
| 🌐 | Building a **cinematic 3D portfolio** with Next.js, Three.js, and GSAP |
| 📚 | Advanced AI coursework — CNNs, transformers, reinforcement learning |
